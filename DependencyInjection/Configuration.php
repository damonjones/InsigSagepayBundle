    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('release_url')->isRequired()->cannotBeEmpty()->end()
                ->scalarNode('abort_url')->isRequired()->cannotBeEmpty()->end()
                ->scalarNode('refund_url')->isRequired()->cannotBeEmpty()->end()
                ->scalarNode('repeat_url')->isRequired()->cannotBeEmpty()->end()
                ->scalarNode('void_url')->isRequired()->cannotBeEmpty()->end()
